...
// - create move generation functions for each piece



#[test]
fn test_create_board() {
    let mut new_board = BoardImpl::new();
...
#[test]
// used for my own sanity 
fn test_or_operation() {
    let x: u64 = 0x000000000000ff00;
    let y: u64 = 0x00ff000000000000;
    let x_or_y = x | y;
    assert(x_or_y == 0x00ff00000000ff00, '')
}
